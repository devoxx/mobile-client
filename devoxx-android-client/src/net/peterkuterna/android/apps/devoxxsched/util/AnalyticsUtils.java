		...
		new AsyncTask<Void, Void, Void>() {
			...
			protected Void doInBackground(Void... voids) {
				try {
					...
					Log.d(TAG, "devoxxsched Analytics trackEvent: " + category
							+ " / " + action + " / " + label + " / " + value);
				} catch (Exception e) {
					// We don't want to crash if there's an Analytics library
					// exception.
					Log.w(TAG, "devoxxsched Analytics trackEvent error: "
		...
		new AsyncTask<Void, Void, Void>() {
			...
			protected Void doInBackground(Void... voids) {
				try {
					...
					Log.d(TAG, "devoxxsched Analytics trackPageView: " + path);
				} catch (Exception e) {
					// We don't want to crash if there's an Analytics library
					// exception.
					Log.w(TAG, "devoxxsched Analytics trackPageView error: "
							+ path, e);
				}
				return null;
			}
