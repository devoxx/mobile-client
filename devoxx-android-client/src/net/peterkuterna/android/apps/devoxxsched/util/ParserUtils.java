...
public class ParserUtils {
	...
	private static String BASE_DEVOXX_WEB_URL = "https://www.devoxx.com/display/DV11/";
	...
	public static boolean isTalk(String blockCode) {
		return (blockCode.startsWith("DV11") || blockCode.startsWith("D11"));
	}
