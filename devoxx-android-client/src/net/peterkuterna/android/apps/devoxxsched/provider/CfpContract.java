...
public class CfpContract {
	...
	interface RoomsColumns {
		...
		/** Encoded polyline of the room. */
		String ROOM_ENCODED_POLY = "room_encoded_poly";
		/** Is te room selectable in the map?. */
		String ROOM_SELECTABLE = "room_selectable";
	}
	...
	interface ParleysPresentationColumns {
		/** Unique string identifying this presentation. */
		String PRESENTATION_ID = "presentation_id";
		/** Title of the presentation. */
		String PRESENTATION_TITLE = "presentation_title";
		/** Body of text explaining this session in detail. */
		String PRESENTATION_SUMMARY = "presentation_summary";
		/** URL to thumbnail of presentation. */
		String PRESENTATION_THUMBNAIL = "presentation_thumbnail";
	}
	...
	interface NewsColumns {
		/** Unique string identifying this news item. */
	...
	public static class Blocks implements BlocksColumns, SyncColumns,
		...
		public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.devoxxsched.block";
		public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.devoxxsched.block";
	...
	public static class Tracks implements TracksColumns, BaseColumns {
		...
		public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.devoxxsched.track";
		public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.devoxxsched.track";
	...
	public static class Rooms implements RoomsColumns, BaseColumns {
		...
		public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.devoxxsched.room";
		public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.devoxxsched.room";
	...
	public static class Sessions implements SessionsColumns, BlocksColumns,
		...
		public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.devoxxsched.session";
		public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.devoxxsched.session";
	...
	public static class Speakers implements SpeakersColumns, SyncColumns,
		...
		public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.devoxxsched.speaker";
		public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.devoxxsched.speaker";
	...
	public static class SessionTypes implements SessionTypesColumns,
		...
		public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.devoxxsched.sessiontype";
		public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.devoxxsched.sessiontype";
	...
	public static class Tweets implements TweetsColumns, BaseColumns {
		...
		public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.devoxxsched.tweet";
		public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.devoxxsched.tweet";
	...
	public static class News implements NewsColumns, BaseColumns {
		...
		public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.devoxxsched.news";
		public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.devoxxsched.news";
	...
	/**
	 * Parleys presentations.
	 */
	public static class ParleysPresentations implements
			ParleysPresentationColumns, BaseColumns {
		public static final Uri CONTENT_URI = BASE_CONTENT_URI.buildUpon()
				.appendPath(PATH_PARLEYS).build();

		public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.devoxxsched.parleys";
		public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.devoxxsched.parleys";

		/** Default "ORDER BY" clause. */
		public static final String DEFAULT_SORT = ParleysPresentationColumns.PRESENTATION_TITLE
				+ " ASC";

		/** Build {@link Uri} for requested {@link #PRESENTATION_ID}. */
		public static Uri buildParleysUri(String parleysId) {
			return CONTENT_URI.buildUpon().appendPath(parleysId).build();
		}

		/**
		 * Build {@link Uri} that references any {@link Tags} associated with
		 * the requested {@link #PRESENTATION_ID}.
		 */
		public static Uri buildTagsDirUri(String parleysId) {
			return CONTENT_URI.buildUpon().appendPath(parleysId)
					.appendPath(PATH_TAGS).build();
		}

		/**
		 * Read {@link #PRESENTATION_ID} from {@link ParleysPresentations}
		 * {@link Uri}.
		 */
		public static String getParleysId(Uri uri) {
			return uri.getPathSegments().get(1);
		}

		/**
		 * Generate a {@link #PRESENTATION_ID} that will always match the
		 * requested {@link ParleysPresentations} details.
		 */
		public static String generateParleysId(int parleysId) {
			return String.valueOf(parleysId);
		}
	}
