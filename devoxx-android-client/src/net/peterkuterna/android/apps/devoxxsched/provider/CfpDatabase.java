...
import net.peterkuterna.android.apps.devoxxsched.provider.CfpContract.BlocksColumns;
import net.peterkuterna.android.apps.devoxxsched.provider.CfpContract.NewsColumns;
import net.peterkuterna.android.apps.devoxxsched.provider.CfpContract.ParleysPresentationColumns;
...
import net.peterkuterna.android.apps.devoxxsched.provider.CfpContract.RoomsColumns;
import net.peterkuterna.android.apps.devoxxsched.provider.CfpContract.SessionTypes;
import net.peterkuterna.android.apps.devoxxsched.provider.CfpContract.SessionTypesColumns;
import net.peterkuterna.android.apps.devoxxsched.provider.CfpContract.Sessions;
import net.peterkuterna.android.apps.devoxxsched.provider.CfpContract.SessionsColumns;
import net.peterkuterna.android.apps.devoxxsched.provider.CfpContract.Speakers;
import net.peterkuterna.android.apps.devoxxsched.provider.CfpContract.SpeakersColumns;
...
import net.peterkuterna.android.apps.devoxxsched.provider.CfpContract.TagsColumns;
import net.peterkuterna.android.apps.devoxxsched.provider.CfpContract.Tracks;
import net.peterkuterna.android.apps.devoxxsched.provider.CfpContract.TracksColumns;
import net.peterkuterna.android.apps.devoxxsched.provider.CfpContract.TweetsColumns;
...
public class CfpDatabase extends SQLiteOpenHelper {
	...
	public interface Tables {
		...
		String PARLEYS_PRESENTATIONS = "parleys_presentations";
		String TAGS = "tags";
		String SESSIONS_SPEAKERS = "sessions_speakers";
		String SESSIONS_TAGS = "sessions_tags";
		String PARLEYS_PRESENTATIONS_TAGS = "parleys_presentations_tags";
		...
		String PARLEYS_PRESENTATIONS_TAGS_JOIN_TAGS = "parleys_presentations_tags "
				+ "LEFT OUTER JOIN tags ON parleys_presentations_tags.tag_id=tags.tag_id";
		...
		String SESSIONS_TAGS_JOIN_PARLAYS_PRESENTATIONS_TAGS_PARLEYS_PRESENTATIONS = "sessions_tags "
				+ "LEFT OUTER JOIN parleys_presentations_tags ON sessions_tags.tag_id=parleys_presentations_tags.tag_id "
				+ "LEFT OUTER JOIN parleys_presentations ON parleys_presentations_tags.presentation_id=parleys_presentations.presentation_id";
	...
	public interface ParleysPresentationsTags {
	...
	private interface References {
		...
		String SPEAKER_ID = "REFERENCES " + Tables.SPEAKERS + "("
				+ Speakers.SPEAKER_ID + ")";
		String PRESENTATION_ID = "REFERENCES " + Tables.PARLEYS_PRESENTATIONS
	...
	public void cleanupLinkTables() {
		...
		try {
			...
			db.execSQL("DELETE FROM " + Tables.SESSIONS_TAGS + " WHERE "
					...
					+ " FROM " + Tables.TAGS + ")");
			db.execSQL("DELETE FROM " + Tables.PARLEYS_PRESENTATIONS_TAGS
					+ " WHERE " + ParleysPresentationsTags.PRESENTATION_ID
					+ " NOT IN (SELECT " + ParleysPresentations.PRESENTATION_ID
					+ " FROM " + Tables.PARLEYS_PRESENTATIONS + ")");
			db.execSQL("DELETE FROM " + Tables.PARLEYS_PRESENTATIONS_TAGS
					+ " WHERE " + ParleysPresentationsTags.TAG_ID
					+ " NOT IN (SELECT " + Tags.TAG_ID + " FROM " + Tables.TAGS
					+ ")");
			db.execSQL("DELETE FROM " + Tables.TAGS + " WHERE " + Tags.TAG_ID
					+ " NOT IN (SELECT " + SessionsTags.TAG_ID + " FROM "
					+ Tables.SESSIONS_TAGS + " UNION SELECT "
					+ ParleysPresentationsTags.TAG_ID + " FROM "
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL("CREATE TABLE " + Tables.ROOMS + " (" + BaseColumns._ID
				...
				+ RoomsColumns.ROOM_LEVEL + " INTEGER,"
				+ RoomsColumns.ROOM_ENCODED_POLY + " TEXT,"
				+ RoomsColumns.ROOM_SELECTABLE + " INTEGER," + "UNIQUE ("
		...
		db.execSQL("CREATE TABLE " + Tables.NEWS + " (" + BaseColumns._ID
				...
				+ " TEXT NOT NULL," + NewsColumns.NEWS_DATE + " TEXT NOT NULL,"
				+ NewsColumns.NEWS_TEXT + " TEXT NOT NULL,"
				+ NewsColumns.NEWS_NEW + " INTEGER NOT NULL DEFAULT 0,"
				+ "UNIQUE (" + NewsColumns.NEWS_ID + ") ON CONFLICT IGNORE)");

		db.execSQL("CREATE TABLE " + Tables.PARLEYS_PRESENTATIONS + " ("
				+ BaseColumns._ID + " INTEGER PRIMARY KEY AUTOINCREMENT,"
				+ ParleysPresentationColumns.PRESENTATION_ID
				+ " TEXT NOT NULL,"
				+ ParleysPresentationColumns.PRESENTATION_TITLE + " TEXT,"
				+ ParleysPresentationColumns.PRESENTATION_SUMMARY + " TEXT,"
				+ ParleysPresentationColumns.PRESENTATION_THUMBNAIL + " TEXT,"
				+ "UNIQUE (" + ParleysPresentationColumns.PRESENTATION_ID
				+ ") ON CONFLICT REPLACE)");

		db.execSQL("CREATE TABLE " + Tables.PARLEYS_PRESENTATIONS_TAGS + " ("
				+ BaseColumns._ID + " INTEGER PRIMARY KEY AUTOINCREMENT,"
				+ ParleysPresentationsTags.PRESENTATION_ID + " TEXT NOT NULL "
				+ References.PRESENTATION_ID + ","
				+ ParleysPresentationsTags.TAG_ID + " TEXT NOT NULL "
				+ References.TAG_ID + "," + "UNIQUE ("
				+ ParleysPresentationsTags.PRESENTATION_ID + ","
				+ ParleysPresentationsTags.TAG_ID + ") ON CONFLICT REPLACE)");
	...
	private static void createIndices(SQLiteDatabase db) {
		...
		db.execSQL("CREATE INDEX " + Tables.PARLEYS_PRESENTATIONS + "_"
				+ ParleysPresentations.PRESENTATION_ID + "_IDX ON "
