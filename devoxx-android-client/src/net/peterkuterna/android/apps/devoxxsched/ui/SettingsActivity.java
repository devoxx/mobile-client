...
import net.peterkuterna.android.apps.devoxxsched.util.AccountUtils;
...
public class SettingsActivity extends PreferenceActivity {
	...
	public static final String UPDATE_UI_ACTION = "net.peterkuterna.android.apps.devoxxsched.UPDATE_UI";
	public static final String AUTH_PERMISSION_ACTION = "net.peterkuterna.android.apps.devoxxsched.AUTH_PERMISSION";
	...
	public static final String KEY_DEVOXXSCHED_VERSION = "devoxxsched_version";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		findPreference(KEY_DEVOXXSCHED_VERSION).setTitle(formatVersion());
