...
import net.peterkuterna.android.apps.devoxxfrsched.provider.CfpContract.SearchSuggest;
...
import net.peterkuterna.android.apps.devoxxfrsched.provider.CfpDatabase.SessionsSearchColumns;
import net.peterkuterna.android.apps.devoxxfrsched.provider.CfpDatabase.SessionsSpeakers;
import net.peterkuterna.android.apps.devoxxfrsched.provider.CfpDatabase.SessionsTags;
import net.peterkuterna.android.apps.devoxxfrsched.provider.CfpDatabase.SpeakersSearchColumns;
import net.peterkuterna.android.apps.devoxxfrsched.provider.CfpDatabase.Tables;
import net.peterkuterna.android.apps.devoxxfrsched.service.CfpSyncService;
import net.peterkuterna.android.apps.devoxxfrsched.util.SelectionBuilder;
