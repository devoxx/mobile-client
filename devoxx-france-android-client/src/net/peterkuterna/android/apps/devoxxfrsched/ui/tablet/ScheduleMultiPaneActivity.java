...
import net.peterkuterna.android.apps.devoxxfrsched.ui.ScheduleFragment;
import net.peterkuterna.android.apps.devoxxfrsched.ui.SessionDetailFragment;
...
public class ScheduleMultiPaneActivity extends BaseMultiPaneActivity implements
	...
	protected void onPostCreate(Bundle savedInstanceState) {
		...
		ViewGroup detailContainer = (ViewGroup) findViewById(R.id.fragment_container_schedule_detail);
	...
	public FragmentReplaceInfo onSubstituteFragmentForActivityLaunch(
		...
		if (SessionsActivity.class.getName().equals(activityClassName)) {
			...
			return new FragmentReplaceInfo(SessionDetailFragment.class,
					"session_detail", R.id.fragment_container_schedule_detail);
		}
		return null;
	}
