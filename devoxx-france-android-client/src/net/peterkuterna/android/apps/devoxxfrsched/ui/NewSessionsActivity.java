...
public class NewSessionsActivity extends BaseMultiPaneActivity {
	...
	public static final String EXTRA_NEW_SESSION_TIMESTAMP = "net.peterkuterna.android.apps.devoxxfrsched.extra.NEW_SESSION_TIMESTAMP";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_newsessions);
