...
public class SessionsFragment extends SherlockListFragment {

	private static final String STATE_CHECKED_POSITION = "checkedPosition";

	public static final String EXTRA_TRACK = "net.peterkuterna.android.apps.devoxxfrsched.extra.TRACK";
