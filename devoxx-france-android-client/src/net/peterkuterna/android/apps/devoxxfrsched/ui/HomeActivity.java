...
import net.peterkuterna.android.apps.devoxxfrsched.service.NewsSyncService;
...
import net.peterkuterna.android.apps.devoxxfrsched.ui.phone.TwitterSearchActivity;
...
public class HomeActivity extends BaseMultiPaneActivity implements
	...
	private void triggerRefresh() {
		...
		newsIntent.putExtra(NewsSyncService.EXTRA_NO_NOTIFICATIONS, true);
			...
			if (mRefreshItem != null) {
				if (mRefreshIndeterminateProgressView == null) {
					...
					mRefreshIndeterminateProgressView = inflater.inflate(
							R.layout.actionbar_progress_spinner, null);
				}
