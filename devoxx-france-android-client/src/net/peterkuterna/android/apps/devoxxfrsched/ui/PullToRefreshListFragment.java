...
import net.peterkuterna.android.apps.devoxxfrsched.ui.widget.PullToRefreshListView;
 ...
 */
public class PullToRefreshListFragment extends SherlockFragment {
	...
	private void ensureList() {
		...
		if (root instanceof PullToRefreshListView) {
			...
			if (!(rawListView instanceof PullToRefreshListView)) {
				if (rawListView == null) {
					throw new RuntimeException(
							"Your content must have a PullToRefreshListView whose id attribute is "
									+ "'android.R.id.list'");
				}
				throw new RuntimeException(
						"Content has view with id attribute 'android.R.id.list' "
								+ "that is not a PullToRefreshListView class");
			}
