...
public class AnalyticsUtils {
	 ...
	 */
	private static final String UACODE = "INSERT_YOUR_UA_CODE_HERE";
		...
		new AsyncTask<Void, Void, Void>() {
			...
			protected Void doInBackground(Void... voids) {
				try {
					...
					Log.d(TAG, "devoxxfrsched Analytics trackEvent: " + category
							+ " / " + action + " / " + label + " / " + value);
				} catch (Exception e) {
					// We don't want to crash if there's an Analytics library
					// exception.
					Log.w(TAG, "devoxxfrsched Analytics trackEvent error: "
		...
		new AsyncTask<Void, Void, Void>() {
			...
			protected Void doInBackground(Void... voids) {
				try {
					...
					Log.d(TAG, "devoxxfrsched Analytics trackPageView: " + path);
				} catch (Exception e) {
					// We don't want to crash if there's an Analytics library
					// exception.
					Log.w(TAG, "devoxxfrsched Analytics trackPageView error: "
							+ path, e);
				}
				return null;
			}
