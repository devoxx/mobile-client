...
import net.peterkuterna.android.apps.devoxxfrsched.ui.BaseMultiPaneActivity;
import net.peterkuterna.android.apps.devoxxfrsched.ui.BaseSinglePaneActivity;
import net.peterkuterna.android.apps.devoxxfrsched.ui.HomeActivity;
import net.peterkuterna.android.apps.devoxxfrsched.ui.MultiPaneActivity.FragmentReplaceInfo;
...
public class ActivityHelper {
	...
	public static ActivityHelper createInstance(SherlockFragmentActivity activity) {
	...
	public void onCreate(Bundle savedInstanceState) {
		if (mActivity instanceof BaseSinglePaneActivity) {
			BaseSinglePaneActivity singlePaneActivity = (BaseSinglePaneActivity) mActivity;
			singlePaneActivity
