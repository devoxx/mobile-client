...
import net.peterkuterna.android.apps.devoxxfrsched.io.LocalExecutor;
import net.peterkuterna.android.apps.devoxxfrsched.io.RemoteExecutor;
import net.peterkuterna.android.apps.devoxxfrsched.io.RoomsHandler;
import net.peterkuterna.android.apps.devoxxfrsched.io.ScheduleHandler;
import net.peterkuterna.android.apps.devoxxfrsched.io.SearchSuggestHandler;
import net.peterkuterna.android.apps.devoxxfrsched.io.SessionTypesHandler;
import net.peterkuterna.android.apps.devoxxfrsched.io.SessionsHandler;
import net.peterkuterna.android.apps.devoxxfrsched.io.SpeakersHandler;
import net.peterkuterna.android.apps.devoxxfrsched.io.TracksHandler;
import net.peterkuterna.android.apps.devoxxfrsched.provider.CfpContract.Sessions;
import net.peterkuterna.android.apps.devoxxfrsched.provider.CfpDatabase;
import net.peterkuterna.android.apps.devoxxfrsched.provider.CfpProvider;
...
public class CfpSyncService extends AbstractSyncService {
	...
	public static final String BASE_URL = "https://cfp.devoxx.com/rest/v1/events/6/";
