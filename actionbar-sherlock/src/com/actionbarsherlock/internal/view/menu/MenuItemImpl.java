 ...
 */
public final class MenuItemImpl implements MenuItem, Comparable<MenuItemImpl> {
	...
	@Override
	public int compareTo(MenuItemImpl another) {
		final Integer order = getOrder();
		final Integer otherOrder = another.getOrder();
